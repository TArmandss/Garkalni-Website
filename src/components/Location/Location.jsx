...
function Location() {
  ...
  const customIcon = new Icon({
    iconUrl: process.env.PUBLIC_URL + '/assets/images/green-location-marker.png',
    ...
    <div className='location-content location'>
      <div className="location-left-content">
        ...
        <button className='triger-location-btn' onClick={mapHandler}>
          <a>
            {displayLocation ? 
              ...
              :  
              <span>Karte <CiLocationOn className='location-icon'/></span>
            }
          </a>
        </button>
      </div>
        ...
        {displayLocation && (
          ...
          >
            <MapContainer className='maps' center={initialCoordinates} zoom={13} style={{ width: '100%', height: '100%' }}>
              <TileLayer
              ...
              <Marker position={initialCoordinates} icon={customIcon}>
                <Popup>
                  ...
                  Latitude: {initialCoordinates[0]}<br />
